...
function Header() {
  ...
  return (
    <header className='flex h-[150px] w-screen justify-start md:justify-around items-center font-fiona text-[32px] p-4 bg-[#F9F7F4]'>
      <LogoHeader/>
      <nav className='flex'>
        ...
        <ul className='hidden lg:flex gap-30 p-10 text-[32px] text-preto-100'>
          <li><a href="#">HOME</a></li>
          <li><a href="#">LOJA</a></li>
