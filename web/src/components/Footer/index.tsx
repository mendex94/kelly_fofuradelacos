    ...
    <footer className="h-[300px] bg-[#BC8383] w-screen flex flex-col md:flex-row items-center justify-around text-[28px] font-normal text-[#F9F7F4]">
      <div className='flex gap-[63px]'>
        <div className='hidden md:inline mb-'>
          <LogoFooter />
          <p className='text-p4'>&copy; 2022 | All Rights Reserved.</p>
        </div>
        <div className='flex flex-col justify-center'>
         <div className='flex gap-[68px]'>
         <div className='flex flex-col font-fiona text-h4'>
            <a href="#">Sobre nós</a>
            <a href="#">Dúvidas</a>
          </div>
          <div className='flex flex-col font-fiona'>
            <a href="#">Loja</a>
            <a href="#">Personalize</a>
          </div>
         </div>
          <div className='flex gap-6 mt-16 text-h4'>
            <a href="#"><img src={InstagramIcon} alt="" /></a>
            <a href="#"><img src={WhatsAppIcon} alt="" /></a>
          </div>
        </div>
      </div>
      <div className='font-fiona text-h4 text-right gap-4 flex-col'>
        <p>Certificados</p>
