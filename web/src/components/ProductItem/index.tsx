      ...
      <div className='container mx-auto flex flex-col lg:flex-row'>
        ...
        <div className='text-black-100 mx-auto flex flex-col max-h-[630px] justify-between w-10/12 md:w-3/12'>
          <div>
            ...
            <div className='mb-4'>
              <p className='text-p3 text-preto-100 max-w-[400px] leading-relaxed mt-4'>{product.notes}</p>
            </div>
            <div>
          ...
          <div>
            ...
            <button onClick={() => handleAddToCart(product)} className='font-montserrat text-h3 whitespace-nowrap font-bege-200 bg-rosa-200 px-9 py-3 w-full rounded-2xl text-[#FFFFFF] font-bold hover:bg-rosa-100'>Adicionar ao carrinho</button>
          </div>
        </div>
      </div>
    </div>
