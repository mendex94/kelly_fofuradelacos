...
function FreteForm() {
  return (
    <div className='bg-[#FFFFFF] py-8 px-5 flex flex-col gap-5 mb-5 md:rounded-lg md:w-[366px]'>
        ...
        <div className='flex gap-4'>
            ...
            <button className='bg-rosa-200 rounded-lg p-2 font-semibold text-bege-100 w-14'>OK</button>
        </div>
    </div>
  )
}
